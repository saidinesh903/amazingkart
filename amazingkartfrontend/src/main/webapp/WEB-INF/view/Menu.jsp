...
<title>amazing kart header</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

</head>
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top navbar-inverse" id="my-navbar">
		<div class="container-fluid">
			<div class="navbar-header ">
				...
				<a href="Home" class="navbar-brand">
					<img src="<c:url value="/resources/images/download.png" />" alt="logo" style="max-height: 50px; margin-top: -15px;margin-left: -15px;">
				</a>
			</div>
